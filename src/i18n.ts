...
const fr = {
  ...
  cfg_BIZ_FALL_HEIGHT: "Hauteur de départ de la chute d'un bâtiment (en niveaux).",
  cfg_BIZ_FALL_SPEED: "Vitesse de chute des bâtiments (niveaux par seconde).",
...
const en: Record<StringKey, string> = {
  ...
  cfg_BIZ_FALL_HEIGHT: "Starting height of a building's fall (in levels).",
  cfg_BIZ_FALL_SPEED: "Building fall speed (levels per second).",
