...
const fr = {
  ...
  missionsNavBtn: "Missions",
  missionsTitle: "MISSIONS",
  missionsToggleTip: "Fermer ou rouvrir le panneau Missions",
  closeMissionsTip: "Fermer le panneau Missions",
  missionColors: "{mark} Livrer toutes les couleurs : {n}/{total}",
  missionDistance: "{mark} Distance véhicules : {v}/{total}",
  missionPackages: "{mark} Colis récupérés : {n}/{total} ({points} pts)",
  ...
  // Menu de debug
  debugHouse: "🏠 House",
  debugHouseTip: "Sélectionner l'outil maison, puis cliquer sur la carte",
  debugBiz: "🏢 Business",
  debugBizTip: "Sélectionner l'outil entreprise, puis cliquer sur la carte",
  debugRiver: "🌊 River",
  debugRiverTip: "Sélectionner l'outil rivière, puis cliquer sur la carte",
  debugTreePine: "🌲 Pine",
  debugTreePineTip: "Sélectionner l'outil sapin, puis cliquer sur la carte",
  debugTreeLeafy: "🌳 Tree",
  debugTreeLeafyTip: "Sélectionner l'outil arbre feuillu, puis cliquer sur la carte",
  debugBike: "🚲 Bike",
  ...
  cfg_MISSION_DISTANCE_CELLS: "Distance totale requise pour la mission (cases).",
  cfg_MISSION_PACKAGES: "Colis récupérés requis pour la mission.",
  ...
  winTitle: "VICTOIRE",
  winText: "Les trois missions sont accomplies. Partagez votre score ou continuez en mode infini.",
  overScore: "Score final : {n}",
  overBest: "Meilleur score : {n}",
  continueInfinite: "Continuer",
  continueInfiniteTip: "Reprendre la ville en mode infini",
  replay: "Rejouer",
  ...
  msgVictory: "Victoire ! Toutes les missions sont accomplies.",
  msgInfiniteMode: "Mode infini activé : le danger ne peut plus provoquer de défaite.",

  // Messages de debug
  dbgHouseAdded: "[debug] Maison ajoutée",
  dbgBizAdded: "[debug] Entreprise ajoutée",
  dbgRiverAdded: "[debug] Rivière ajoutée",
  dbgTreeAdded: "[debug] Arbre ajouté",
  dbgBuildingRemoved: "[debug] Bâtiment démoli",
  dbgRiverRemoved: "[debug] Rivière retirée",
...
const en: Record<StringKey, string> = {
  ...
  missionsNavBtn: "Missions",
  missionsTitle: "MISSIONS",
  missionsToggleTip: "Close or reopen the Missions panel",
  closeMissionsTip: "Close the Missions panel",
  missionColors: "{mark} Deliver every color: {n}/{total}",
  missionDistance: "{mark} Vehicle distance: {v}/{total}",
  missionPackages: "{mark} Packages picked up: {n}/{total} ({points} pts)",
  ...
  debugHouse: "🏠 House",
  debugHouseTip: "Select the house tool, then click the map",
  debugBiz: "🏢 Business",
  debugBizTip: "Select the business tool, then click the map",
  debugRiver: "🌊 River",
  debugRiverTip: "Select the river tool, then click the map",
  debugTreePine: "🌲 Pine",
  debugTreePineTip: "Select the pine tool, then click the map",
  debugTreeLeafy: "🌳 Tree",
  debugTreeLeafyTip: "Select the leafy tree tool, then click the map",
  debugBike: "🚲 Bike",
  ...
  cfg_MISSION_DISTANCE_CELLS: "Total distance required for the mission (cells).",
  cfg_MISSION_PACKAGES: "Packages picked up required for the mission.",
  ...
  winTitle: "VICTORY",
  winText: "All three missions are complete. Share your score or keep playing in endless mode.",
  overScore: "Final score: {n}",
  overBest: "Best score: {n}",
  continueInfinite: "Continue",
  continueInfiniteTip: "Resume the town in endless mode",
  replay: "Play again",
  replayTip: "New game",
  ...
  msgVictory: "Victory! All missions are complete.",
  msgInfiniteMode: "Endless mode enabled: danger can no longer cause defeat.",

  dbgHouseAdded: "[debug] House added",
  dbgBizAdded: "[debug] Business added",
  dbgRiverAdded: "[debug] River added",
  dbgTreeAdded: "[debug] Tree added",
  dbgBuildingRemoved: "[debug] Building demolished",
  dbgRiverRemoved: "[debug] River removed",
